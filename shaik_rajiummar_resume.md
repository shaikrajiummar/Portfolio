...
## TECHNICAL SKILLS
* **Programming Languages:** Java, Python, JavaScript (ES6+), HTML5, CSS3, SQL
* **Frameworks & Libraries:** React.js, Node.js, Express.js, Tailwind CSS, Bootstrap, Vite, JDBC, D3.js
* **Databases:** MySQL, PostgreSQL, MongoDB, Database Design & Normalization
* **Developer Tools & Version Control:** Git, GitHub, VS Code, Salesforce CLI
* **Software Engineering Concepts:** Data Structures & Algorithms (DSA), Software Development Life Cycle (SDLC), Object-Oriented Programming (OOP), RESTful APIs, Web Scraping, Database Management Systems (DBMS), Agile Methodologies

## EDUCATION
**Bachelor of Technology (B.Tech) in Computer Science Engineering**  
Malla Reddy University, Hyderabad | *September 2022 – Present*  
* **Cumulative Grade: 8.74 CGPA**
* **Relevant Coursework:** Data Structures and Algorithms, Database Management Systems, Operating Systems, Computer Networks, Software Engineering

**Intermediate Education (Class XII - MPC)**  
Sri Chaitanya Junior College, Khammam | *Graduation: 2022*  
* **Final Score: 85.7%**

**Secondary School Certificate (Class X)**  
Madhu Vidyalayam | *Graduation: 2020*  
* **Final Score: 95.0%**

## ACADEMIC PROJECTS

### **Blood Donor Web Application** (React.js, Node.js, Express.js, MongoDB)
* **Description:** Developed a scalable full-stack portal linking donors, hospitals, and blood banks to resolve emergency blood inventory shortages.
* **Key Contributions:**
...
### **Student ERP System** (Java, JDBC, MySQL, HTML, CSS, JavaScript)
* **Description:** Designed and engineered a centralized ERP portal for academic timeline scheduling, administrative registers, and attendance management.
* **Key Contributions:**
...
### **CricSta - Cricket Stats Web App** (Python, BeautifulSoup, HTML, CSS, JavaScript)
* **Description:** Built a sports statistics portal scraping and visualizing ODI metrics, ICC tournament highlights, and live match standing data.
* **Key Contributions:**
...
### **Jackie Jeans Onboarding Experience** (React.js, Tailwind CSS, Web Speech API)
* **Description:** Developed a premium, mobile-first brand onboarding portal featuring sizing calculations and hands-free voice assistance.
* **Key Contributions:**
...
### **IndusMind AI Platform** (React.js, Vite, D3.js, NLP/RAG)
* **Description:** Architected an enterprise industrial intelligence platform incorporating smart compliance audits and node-graph tracking.
* **Key Contributions:**
...
* **Artificial Intelligence Foundations** – IBM SkillsBuild (Credential Verified)
* **Data Analytics Job Simulation** – Deloitte (Simulation Completed)
* **Introduction to Java** – HP Life (Credential Verified)
* **Data Science and Analytics** – Coursera (Credential Verified)

## LEADERSHIP & VOLUNTARY WORK
* **Student Ambassador** | *LetsUpgrade EdTech Pvt. Ltd.*
  * Conducted student outreach campaigns, promoting coding literacy and tech-course enrollments.
* **Blood Donation Volunteer** | *Campus Social Drives*
